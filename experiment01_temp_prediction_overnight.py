...
一晩版：
  本日版 (19:10-20:10, 1時間) は検証期間の温度変動が 0.1°C しかなく、
  予測問題として易しすぎた。ここでは夜間の温度変動幅が拡大する
  19:30-翌07:00 の一晩データで線形性・MLP の優位性を再評価する。
...
DATA_DIR = "data"
OUTPUT_DIR = "experiment01_overnight"
os.makedirs(OUTPUT_DIR, exist_ok=True)

EXPERIMENT_START = pd.Timestamp("2026-04-18 19:30:00")
EXPERIMENT_END = pd.Timestamp("2026-04-19 07:00:00")
TRAIN_RATIO = 2/3

print("=" * 70)
print("実験①（一晩版）: 隣接ノードの温度予測")
print("=" * 70)
...
ax.set_xlabel("Time")
ax.set_title("Predicted vs actual (test period, overnight)")
...
ax.set_title("Model comparison (overnight)")
ax.legend()
ax.grid(True, alpha=0.3)
